...
public class BoardServiceImpl implements BoardService {
    ...
    private boolean maxLocationOnBoard(int anchorLocation, Orientation orientation, int shipLength){
        int endLocation = anchorLocation + (shipLength-1) * orientation.getInterval();
